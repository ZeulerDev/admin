...
const routes = [
  ...
  { path: '/virtual/markets', name: 'Virtual Markets ', element: VirtualMarkets },
  { path: '/virtual', name: 'Virtual', element: VirtualMarkets,exact: true },
  ...
  { path: '/order/view', name: 'Orders', element: Order },
  { path: '/order', name: 'Multiple Delivery', element: Order,exact: true },
